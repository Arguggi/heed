...
import Heed.Database (afterDefTime, defFeedInfo, defFeedItem, FeedItemHW, _feedItemDate, _feedItemTitle, _feedItemUrl)
...
import Text.XML (documentRoot, parseLBS_, Node, elementName)
import qualified Text.XML
import Text.XML.Cursor (fromDocument, hasAttribute, child, node, element, content, attribute, descendant, laxElement, (&//), ($//), (&/), (&|), ($/))
...
veritasiumxml = [Text.RawString.QQ.r|<?xml version="1.0" encoding="UTF-8"?>
